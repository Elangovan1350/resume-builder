        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col gap-6">
            {experienceFields.map((field, index) => (
              <div
                key={field.id}
                className="bg-white/5 backdrop-blur-sm rounded-2xl p-2 py-6 border border-white/10 shadow-lg hover:shadow-xl transition-all duration-300"
              >
        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col gap-6">
            {educationFields.map((field, index) => (
              <div
                key={field.id}
                className="bg-white/5 backdrop-blur-sm rounded-2xl px-2 py-6 border border-white/10 shadow-lg hover:shadow-xl transition-all duration-300"
              >
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-base sm:text-lg font-semibold text-white">
                    Education {index + 1}
