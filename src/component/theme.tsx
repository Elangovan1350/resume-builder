...
const Theme = () => {
  ...
  return (
    <button
      onClick={handleTheme}
      className={`fixed top-4 left-4 z-50 px-4 py-3 rounded-xl shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 flex items-center gap-2 font-medium ${
        theme
